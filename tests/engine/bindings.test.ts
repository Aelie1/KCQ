...
describe("binding behavior through GameEngine", () => {
    it("adds, accumulates, scales above Impossible, caps, and removes a binding", () => {
        ...
        expect(use(engine, "hero", "add-20").events[0].effects[0]).toEqual({
            type: "bondageChanged",
            target: "hero",
            binding: "rope",
            amount: 7,
        ...
        expect(use(engine, "hero", "add-1000").events[0].effects[0]).toEqual({
            type: "bondageChanged",
            target: "hero",
            binding: "rope",
            amount: 18,
        ...
        expect(use(engine, "hero", "remove-7").events[0].effects[0]).toEqual({
            type: "bondageChanged",
            target: "hero",
            binding: "rope",
            amount: -7,
        ...
        expect(use(engine, "hero", "remove-all").events[0].effects[0]).toEqual({
            type: "bondageRemoved",
            target: "hero",
            binding: "rope",
            amount: -93,
